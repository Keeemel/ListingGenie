...
// Colors shifted to indigo/violet via CSS hue-rotate on the canvas.
...
export function AnimatedShaderHero({ children, className = "" }: AnimatedShaderHeroProps) {
  ...
  useEffect(() => {
    ...
    // Try WebGL2 — hard requirement for #version 300 es
    const gl = canvas.getContext("webgl2");
    if (!gl) {
      console.warn("[AnimatedShaderHero] WebGL2 not available — shader disabled");
      return;
    }
  ...
  return (
    ...
    >
      ...
      <canvas
        ...
        style={{ filter: "hue-rotate(210deg) saturate(1.1) brightness(0.72)" }}
        aria-hidden="true"
      />

      {/* Bottom vignette → zinc-950 */}
      <div
